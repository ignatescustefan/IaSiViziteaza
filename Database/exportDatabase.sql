--------------------------------------------------------
--  File created - Saturday-November-09-2019   
--------------------------------------------------------
DROP SEQUENCE "PROIECT"."ACCES_RIGHT_ID_ACCES_RIGHT_SEQ";
DROP SEQUENCE "PROIECT"."ATTRACTION_ID_ATTRACTION_SEQ";
DROP SEQUENCE "PROIECT"."ATTRACTION_TYPE_ID_ATTRACTION_";
DROP SEQUENCE "PROIECT"."COMMENT_ID_COMMENT_SEQ";
DROP SEQUENCE "PROIECT"."ISEQ$$_75131";
DROP SEQUENCE "PROIECT"."ISEQ$$_75134";
DROP SEQUENCE "PROIECT"."ISEQ$$_75137";
DROP SEQUENCE "PROIECT"."ISEQ$$_75141";
DROP SEQUENCE "PROIECT"."ISEQ$$_75144";
DROP SEQUENCE "PROIECT"."ISEQ$$_75148";
DROP SEQUENCE "PROIECT"."LOCATION_ID_LOCATION_SEQ";
DROP SEQUENCE "PROIECT"."USER_ID_USER_SEQ";
DROP TABLE "PROIECT"."ACCES_RIGHT" cascade constraints;
DROP TABLE "PROIECT"."ATTRACTION" cascade constraints;
DROP TABLE "PROIECT"."ATTRACTION_TYPE" cascade constraints;
DROP TABLE "PROIECT"."COMMENT" cascade constraints;
DROP TABLE "PROIECT"."LOCATION" cascade constraints;
DROP TABLE "PROIECT"."USER" cascade constraints;
DROP TABLE "PROIECT"."USER_TO_RIGHT" cascade constraints;
DROP PROCEDURE "PROIECT"."UPDATE_ATTRACTION_RATING";
DROP PROCEDURE "PROIECT"."UPDATE_COMMENT_RATING";
DROP PACKAGE "PROIECT"."DELETE_PROCEDURE";
DROP PACKAGE "PROIECT"."GET_FUNCTION";
DROP PACKAGE "PROIECT"."INSERT_PROCEDURE";
DROP PACKAGE "PROIECT"."USER_METHODS";
DROP PACKAGE BODY "PROIECT"."DELETE_PROCEDURE";
DROP PACKAGE BODY "PROIECT"."GET_FUNCTION";
DROP PACKAGE BODY "PROIECT"."INSERT_PROCEDURE";
DROP PACKAGE BODY "PROIECT"."USER_METHODS";
--------------------------------------------------------
...
Insert into PROIECT.ATTRACTION (ID_ATTRACTION,NAME,DESCRIPTION,OPEN_TIME,CLOSE_TIME,CREATE_ATTRACTION_TIME,IMAGE_PATH,LOCATION_ID_LOCATION,ATT_TYPE_ID_ATTRACTION_TYPE,USER_ID_USER,RATING,PHONE_NUMBER) values (2,'o fain','adsasd',to_date('03-NOV-19','DD-MON-RR'),to_date('03-NOV-19','DD-MON-RR'),to_date('03-NOV-19','DD-MON-RR'),'botanica8_11_2019_11_11_30_45.png',2,1,2,1,'31231');
