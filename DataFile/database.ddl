...
CREATE TABLE attraction (
    ...
    location_id_location          NUMBER(7) NOT NULL,
    att_type_id_attraction_type   NUMBER(7) NOT NULL,
...
CREATE TABLE "COMMENT" (
    ...
    user_id_user               NUMBER(7) NOT NULL,
    attraction_id_attraction   NUMBER(7) NOT NULL
)
LOGGING;
...
ALTER TABLE attraction
    ADD CONSTRAINT attraction_attraction_type_fk FOREIGN KEY ( att_type_id_attraction_type )
        REFERENCES attraction_type ( id_attraction_type )
    NOT DEFERRABLE;

ALTER TABLE attraction
    ADD CONSTRAINT attraction_location_fk FOREIGN KEY ( location_id_location )
        REFERENCES location ( id_location )
    NOT DEFERRABLE;

ALTER TABLE attraction
    ADD CONSTRAINT attraction_user_fk FOREIGN KEY ( user_id_user )
        REFERENCES "USER" ( id_user )
    NOT DEFERRABLE;

ALTER TABLE "COMMENT"
    ADD CONSTRAINT comment_attraction_fk FOREIGN KEY ( attraction_id_attraction )
        REFERENCES attraction ( id_attraction )
    NOT DEFERRABLE;

ALTER TABLE "COMMENT"
    ADD CONSTRAINT comment_user_fk FOREIGN KEY ( user_id_user )
        REFERENCES "USER" ( id_user )
    NOT DEFERRABLE;

ALTER TABLE location
    ADD CONSTRAINT location_attraction_fk FOREIGN KEY ( attraction_id_attraction )
        REFERENCES attraction ( id_attraction )
    NOT DEFERRABLE;
